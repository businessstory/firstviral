      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <a
              href="https://www.instagram.com/_business.story/"
              target="_blank"
              rel="noreferrer"
              aria-label="인스타그램"
              className="flex h-8 w-8 items-center justify-center rounded-full text-neutral-500 transition-colors hover:bg-brand-50 hover:text-brand-700"
            >
            ...
            <a
              href="https://www.youtube.com/@Betory100/featured"
              target="_blank"
              rel="noreferrer"
              aria-label="유튜브"
              className="flex h-8 w-8 items-center justify-center rounded-full text-neutral-500 transition-colors hover:bg-brand-50 hover:text-brand-700"
